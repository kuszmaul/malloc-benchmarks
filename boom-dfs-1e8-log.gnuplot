...
set output 'boom-dfs-1e8-log.pdf'
unset clip points
set clip one
unset clip two
unset clip radial
...
set xlabel "log_2(max object size)" 
set xlabel  font "" textcolor lt -1 norotate
set x2label "" 
set x2label  font "" textcolor lt -1 norotate
set xrange [ * : * ] noreverse writeback
set x2range [ * : * ] noreverse writeback
set ylabel "maxRSS/(class count)" 
...
plot "boom-glibc.data" using (log($1)/log(2)):(($2)/column(0)) with lines
#    EOF
