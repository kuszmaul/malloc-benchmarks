...
ratio at most $\log n + O(1)$, where $n$ is the maximum amount ever allocated
(or the maximum object size). So there's a factor of two gap between the upper
and lower bound.
...
memory-allocation algorithm (between $0.5 \log n$ and $0.84 \log n$ I think,
